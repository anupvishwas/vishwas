        ...
        while(true)
        {
           ...
           do
           {
               ...
               switch(choice)
               {
                   ...
                   case 2:ob.Men();break;
                   case 3:ob.kids();break;
                   case 4:ob.Shoes();break;
                   default:System.out.println("check your choice");
               }
               /*
                System.out.println("Your bill=");
                System.out.println("serial no."+"   "+"item name"+"      "+"cost of the items");
                for(int i=0;i<ob.z;i++)
                {
                    System.out.println(i+1+"  "+ob.name[i]+"Rs"+ob.prize[i]);
                    billamt=ob.cost+billamt;
                    System.out.println("total bill amount="+billamt);
                    System.out.println("continue shopping with us");
                ...
                */
                public void Women()
                {
                    ...
                    System.out.println("Extremely delighted to to announce that!!!!!!");
                    System.out.println("We provide 15% discount in the Casual Wear section");
                    int choice1=s.nextInt();
                    switch (choice1)
                    {
                        case 1:System.out.println(" Ethinic Section!");
                        ...
                        if(c1==1)
                        {
                         ...
                         if (c1==2)
                         {
                            ...
                            else if(c1==5)
                            {
                                ...
                                System.out.println("not aplicable");break;
                                case 2:
                                System.out.println("yay!!!chillin in your casuals");
                                ...
                                else if(c1==4)
                                {
                                    ...
                                    price[z]=discount;
                                    z++;
                                    System.oiut.println("The Cost Of the Item is Rs 400 but after discount is"+discount);
                                    cost=cost+discount;
                                }
                                else
                                System.out.println("not applicable");
                                case 3:System.out.println("Party and Western wear.....get ready to PARTY!!!!...");
                                System.out.println("All sizes between S and XL are available");
                                System.out.pritnln("Enter the no. according to your choice");
                                System.out.pritnln("Enter 1 for denim");
                                System.out.pritnln("Enter 2 for Fancy Tops");
                                System.out.pritnln("Enter 3 for Dresses");
                                int c1=nextInt();
                                if(c1==1)
                                {
                                        name[z]="Denim";
                                        price[z]=600;
                                        z++;
                                        System.out.pritnln("The cost of the item is Rs 600");
                                        cost=cost+600;
                                    }
                                    else if(c1==2)
                                    {
                                        ...
                                        price[z]=400;
                                        z++;
                                        System.out.pritnln("The cost of the item is Rs 400");
                                        cost=cost+400;
                                    }
                                    else if(c1==3)
                                    {
                                ...
                                {System.out.pritnln("not applicable");}
                                ...
                                public void Men()
                                {
                                    ...
                                    switch(choice1)
                                    {
                                        case 1:System.out.println("Ethnic Section!!!");
                                        System.out.println("All sizes from S to XL are available");
                                        System.out.println("Enter the no.s according to your choice");
                                        ...
                                        System.out.println("Not valid");
                                        break;
                                        case 3:System.out.println("FORMALS for the run");
                                        System.out.println("All sizes from S to XL are available");
                                        System.out.println("enter the no. according to your choice");
                                    ...
                                    public void kids()
                                    {
                                        ...
                                        switch(choice1)
                                        {
                                            case 1:System.out.println("This the infant sections for your tots");
                                            ...
                                            if(gender.equalsIgnoreCase("male"))
                                            {
                                                ...
                                                if(gender.equalsIgnoreCase("female"))
                                                {
                                                    ...
                                                    System.out.println("Not valid");break;
                                                    case 2:System.out.println("All ages from 1 to 6 are available");
                                                    ...
                                                    case 3:System.out.println("The clothing is categorised between age group 7 to 14");
                                                    {    
                                                        System.out.println("Enter the gender");
                                                        gender=s.next();
                                                        if(gender.equalsIgnoreCase("female"))
                                                       ...
                                                       else if(gender.equalsIgnoreCase("male"))
                                                       {
                                                        ...
                                                        public void Shoes()
                                                        {
                                                            ...
                                                            switch(choice1)
                                                            {
                                                                case 1:System.out.println("MEN'S FOOTWEAR!!!");
                                                                System.out.println("Make sure to choose the shoes depending on the size");
                                                                System.out.prinyln("Enter 1 for Sports Shoes");
                                                                ...
                                                                else if(c1==3)
                                                                {
                                                                        ...
                                                                        cost=cost+600;                                                                       System.out.println("The cost of Sandals and flip-flops is Rs 600");
                                                                }
                                                                ...
                                                                System.out.println("not valid");
                                                                    ...
                                                                    case 2:System.out.println("WOMEN'S FOOTWEAR");
